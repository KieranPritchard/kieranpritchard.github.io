...
description: "An overview of my React-based portfolio featuring CTF write-ups processed via a custom Python pipeline. I engineered this system to securely fetch Markdown files from a private repository and transform them into a public-facing showcase using Tailwind CSS. It highlights my ability to automate secure data workflows while serving as a professional reference for my cybersecurity and ethical hacking skills."
date: 2026-01-30
featured: true
topics: ["Cyber Security", "Ethical-Hacking"]
header_image: "../res/Header-Images/project-header-images/CTF Write up Thumbnail.webp"
icon: "../res/Icons/portfolio-icons/CTF Write Up Thumnail.webp"
breadcrumb: ["CTF Write-Up Showcase"]
---
...
[View the portfolio here](https://kieranpritchard.github.io/CTF-Showcase/#/)